      ...
      <div className="container contact-container">
        ...
        <div className="contact-header reveal">
          ...
          <p className="contact-desc">
            Order ahead of time and we will make sure your order will be waiting
            for you.
          </p>
          ...
          <div className="branch-card reveal reveal--left reveal--d1">
            ...
            <div className="branch-grid">
              <div className="info-card">
                ...
                <div className="info-text">
                  ...
                  <span className="info-value">
                    +264 81 247 6318 [Christine]
                  </span>
                  <span className="info-value">+264 81 743 9047 [Mieke]</span>
                  <span className="info-value">+264 63 222 004 [Landline]</span>
                </div>
              </div>
              ...
              <div className="info-card">
                ...
                <div className="info-text">
                  <span className="info-label">Email Addresses</span>
            ...
            <div className="branch-grid">
              <div className="info-card">
                ...
                <div className="info-text">
                  ...
                  <span className="info-value">+264 81 743 9047 [Mieke]</span>
                  <span className="info-value">+264 63 247 785 [Landline]</span>
                </div>
              </div>
        ...
        <div className="contact-bottom">
          <form className="contact-form reveal reveal--d4" onSubmit={onSubmit}>
            <div className="contact-form__header">
              <span className="contact-form__kicker">Send a message</span>
            </div>
